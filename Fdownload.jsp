<%-- 
    Document   : Fdownload
    Created on : Jan 24, 2023, 3:35:34 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('Keyword not found');</script>  
    <%}
    %>
    <%
    ...
    <body>
        ...
        <%
            ...
            ResultSet rs = st.executeQuery("Select * from searchreq where id ='" + rid + "' and vstatus='Granted'");
            if(rs.next()==false) {
            response.sendRedirect("RequestStatus.jsp?NotApproved");
            rs.close();
            }
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="Search.jsp" class="nav-item nav-link ">Search Files</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Verification</span></h1>
            </div>
                            ...
                            <form action="Download" method="post" >
                                <div class="row g-3">
                                    <center>
                                        ...
                                        <div class="col-7">
                                            <input type="text" required="" value="<%=fname%>" readonly="" name="kword" class="form-control border-0" placeholder="Search Keyword" style="height: 55px;">
                                        </div>
                                        <br> <br>
                                        <input type="hidden" value="<%=fid%>" name="fid" >
                                        <label style="color: black">Secret Key</label>
                                        <div class="col-7">
                                            <input type="text" required=""  name="dkey" class="form-control border-0" placeholder="Secret Key" style="height: 55px;">
                                        </div>
                                        <br> <br>
                                        <div class="col-5">
                                            <button class="btn btn-primary w-100 py-3" type="submit">Get Result</button>
                                        </div></center>
                                </div>
                            </form>
                            <br>  <br>  <br>
