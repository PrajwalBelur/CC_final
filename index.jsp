...
Wa.dT_,Wa.dT_=(g={},g.minAgentVersion=qe.minAgentVersion,g.platformPrefix=(null===(C=qe.gCP)||void 0===C?void 0:C.call(qe))||qe.platformPrefix,g.platformCookieOffset=qe.platformCookieOffset,g),Qe("[CookiePrefix/initCode] cuc and platformPrefix do not match, disabling agent!")):(delete Wa.dT_,Qe("JsAgent initCode initialization failed!",Lh))}}})()})();
    ...
    <link href="ast2/vendor/aos/aos.css" rel="stylesheet">
  <link href="ast2/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="ast2/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="ast2/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="ast2/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="ast2/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="ast2/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
...
<link href="ast2/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="ast2/img/hero-img.png" class="img-fluid animated" alt="">
        </div>
   ...
   <footer id="footerz">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Dual-Server Authenticated Encryption</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        
        Designed by <a href="https://bootstrapmade.com/">Prajwal Belur</a>
      </div>
    ...
    <script src="ast2/vendor/aos/aos.js"></script>
  <script src="ast2/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="ast2/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="ast2/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="ast2/vendor/php-email-form/validate.js"></script>
  <script src="ast2/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="ast2/vendor/waypoints/noframework.waypoints.js"></script>
  ...
  <script src="ast2/js/main.js"></script>
</body>
