<%-- 
    Document   : FileUpload
    Created on : Jan 23, 2023, 11:09:45 PM
    Author     : Murthi
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="DOHome.jsp" class="nav-item nav-link">Home</a>
                        <a href="FileUpload.jsp" class="nav-item nav-link active">File Upload</a>
                        <a href="MyFiles.jsp" class="nav-item nav-link">My Files</a>
                         <a href="KeywordIndex.jsp" class="nav-item nav-link">Keyword Index</a>
                        <a href="FileTransactions.jsp" class="nav-item nav-link">File Transactions</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">File Upload</span></h1>
            </div>
                            ...
                            <form action="Upload" method="post" ENCTYPE="multipart/form-data">
                                <div class="row g-3">
                                    <center><div class="col-7">
                                            <input type="text" required=""  name="kword" class="form-control border-0" placeholder="Keyword" style="height: 55px;">
                                        </div>
                                        <br> 
                                        
                                         <br> <label style="color: black">Choose the file</label><br> 
                                        <div class="col-7">
                                            
                                            <input type="file" required="" accept=".txt" name="upfile" class="form-control border-0" placeholder="" style="height: 55px;">
                                        </div>
                                        <br> <br>
                                        <div class="col-5">
