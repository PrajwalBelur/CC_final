<%-- 
    Document   : DRFileTransactions
    Created on : Jan 24, 2023, 4:05:40 PM
    Author     : Murthi
--%>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="DRFileTransactions.jsp" class="nav-item nav-link active">File Transactions</a>
            ...
            <div class="row gx-0 align-items-center">
                <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from downloads where drid ='"+drid+"'");
                                        while (rs.next()) {
                                %>
                                <tr>
