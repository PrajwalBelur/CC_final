<%-- 
    Document   : DataReceiverDetails
    Created on : Jan 23, 2023, 10:47:09 PM
    Author     : Murthi
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="DataReceiverDetails.jsp" class="nav-item nav-link active">DR Details</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-6 text-uppercase mb-4"><span class="text-primary">Data Receiver Details</span></h1>
            </div>
