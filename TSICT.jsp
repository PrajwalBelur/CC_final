<%-- 
    Document   : TSICT
    Created on : Jan 24, 2023, 1:35:07 PM
    Author     : Murthi
--%>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="TSFileRequests.jsp" class="nav-item nav-link">File Requests</a>
                        <a href="TSICT.jsp" class="nav-item nav-link active">Intermediate Cipher Text </a>
            ...
            <div class="row gx-0 align-items-center">
                <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from searchreq where vstatus ='Verified' and serverid='AS'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="TSICT?id=<%=rs.getString("id")%>&fid=<%=rs.getString("fid")%>"  class="btn btn-success" style="color: white">&nbsp;Process</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
