<%-- 
    Document   : Search
    Created on : Jan 24, 2023, 10:54:25 AM
    Author     : Murthi
--%>
    ...
    <body>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Search Files</span></h1>
            </div>
                            ...
                            <form action="searchdata.jsp" method="post" >
                                <div class="row g-3">
                                    <center><div class="col-7">
                                            <input type="text" required=""  name="kword" class="form-control border-0" placeholder="Search Keyword" style="height: 55px;">
                                        </div>
                                        <br> <br>
                                        <div class="col-5">
