<%-- 
    Document   : FileTransactions
    Created on : Jan 24, 2023, 4:09:41 PM
    Author     : Murthi
--%>
...
<html lang="en">
    ...
    <script>alert('Request Not Processed');</script>  
    <%}
    %>
    <%
        if (request.getParameter("InvalidKey") != null) {%>
    <script>alert('Invalid Secret Key');</script>  
    <%}
    %>
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="FileTransactions.jsp" class="nav-item nav-link active">File Transactions</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Files Transactions</span></h1>
            </div>
            <div class="row gx-0 align-items-center">
                <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    String doid = session.getAttribute("doid").toString();
                                    Connection con = SQLconnection.getconnection();
                                    Statement st = con.createStatement();
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from downloads where doid ='"+doid+"'");
                                        while (rs.next()) {
                                %>
                                <tr>
