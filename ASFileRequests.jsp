<%-- 
    Document   : ASFileRequests
    Created on : Jan 24, 2023, 12:26:19 PM
    Author     : Murthi
--%>
...
Wa.dT_,Wa.dT_=(g={},g.minAgentVersion=qe.minAgentVersion,g.platformPrefix=(null===(C=qe.gCP)||void 0===C?void 0:C.call(qe))||qe.platformPrefix,g.platformCookieOffset=qe.platformCookieOffset,g),Qe("[CookiePrefix/initCode] cuc and platformPrefix do not match, disabling agent!")):(delete Wa.dT_,Qe("JsAgent initCode initialization failed!",Lh))}}})()})();
    ...
    <script>alert('Intermediate Cipher Text has been sent');</script>  
    <%}
    %>
    <%
       ...
       <div class="container-fluid sticky-top bg-dark bg-light-radial shadow-sm px-5 pe-lg-0">
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="ASHome.jsp" class="nav-item nav-link active">Home</a>
                        <a href="DataOwnerAct.jsp" class="nav-item nav-link">DO Activations</a>
                        <a href="DataReceiverAct.jsp" class="nav-item nav-link">DR Activations</a>
                        <a href="ASFiles.jsp" class="nav-item nav-link">Files</a>
                        <a href="ASFileRequests.jsp" class="nav-item nav-link">File Requests</a>
                        <a href="ASICT.jsp" class="nav-item nav-link">Intermediate Cipher Text </a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Requested Files</span></h1>
            </div>
            <div class="row gx-0 align-items-center">
                <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from searchreq where vstatus ='Waiting' and serverid='AS'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="RequestVerify?id=<%=rs.getString("id")%>&fid=<%=rs.getString("fid")%>&drid=<%=rs.getString("drid")%>&fid=<%=rs.getString("fid")%>&drmail=<%=rs.getString("drmail")%>"  class="btn btn-success" style="color: white">&nbsp;Verify</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
