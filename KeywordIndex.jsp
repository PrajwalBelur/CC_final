<%-- 
    Document   : KeywordIndex
    Created on : Jan 23, 2023, 11:42:37 PM
    Author     : Murthi
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="KeywordIndex.jsp" class="nav-item nav-link active">Keyword Index</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">Keyword Index</span></h1>
            </div>
            <div class="row gx-0 align-items-center">
                <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from encindex where doid ='" + oid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
