<%-- 
    Document   : MyFiles
    Created on : Jan 23, 2023, 11:32:09 PM
    Author     : Murthi
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="MyFiles.jsp" class="nav-item nav-link active">My Files</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 text-uppercase mb-4"><span class="text-primary">My Files</span></h1>
            </div>
            <div class="row gx-0 align-items-center">
                <center><table id="naresh">
                                ...
                                <%
                                    String oid = session.getAttribute("doid").toString();
                                    Connection con = SQLconnection.getconnection();
                                    Statement st = con.createStatement();
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from uploads where doid ='" + oid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
