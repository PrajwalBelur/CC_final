<%-- 
    Document   : DataOwnerDetails
    Created on : Jan 23, 2023, 10:46:53 PM
    Author     : Murthi
--%>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="DataOwnerDetails.jsp" class="nav-item nav-link active">DO Details</a>
        ...
        <div class="container-fluid py-6 px-5">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-6 text-uppercase mb-4"><span class="text-primary">Data Owner Details</span></h1>
            </div>
            <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from dataowners");
                                        while (rs.next()) {
                                %>
                                <tr>
